...
const SignUp = () => {
  ...
  const { signInWithGoogle, registerWithEmailAndPassword } = useContext(AuthContext);
  ...
  return (
    ...
    <section className = 'mt-20 mb-20 padding max-container flex flex-wrap gap-9 bg-primary bg-hero bg-cover'>
        ...
        <CardBody className="flex flex-col gap-4 pt-10 pb-3">
                <div className= 'mb-5'>
                <Input label="Name" size="lg" className="rounded-[20px] pb-2 pt-2"/>
                </div>
                <div className= 'mb-5'>
            ...
            <CardFooter className="pt-0">
                ...
                <div className="flex justify-center">
                    <Button label='Sign up' onClick={registerWithEmailAndPassword}/>
                </div>
            ...
            <p
              ...
              OR
                ...
                <div className= 'mb-5'>
                <button className="mt-5 w-full flex justify-center items-center bg-white dark:bg-gray-900 border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" onClick={signInWithGoogle}>
